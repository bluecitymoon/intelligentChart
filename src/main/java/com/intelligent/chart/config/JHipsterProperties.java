...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "intelligentChart@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "intelligentChart API";

        private String description = "intelligentChart API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "intelligentChart";
