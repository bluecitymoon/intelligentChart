...
import com.intelligent.chart.service.mapper.PersonMapper;
...
public class PersonResourceIntTest {
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getChineseName()).isEqualTo(DEFAULT_CHINESE_NAME);
    ...
    public void updatePerson() throws Exception {
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getChineseName()).isEqualTo(UPDATED_CHINESE_NAME);
